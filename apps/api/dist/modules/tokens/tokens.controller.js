...
let TokensController = class TokensController {
    ...
    async generateToken(dto) {
        return this.tokensService.generateToken(dto.patientId, dto.departmentId, dto.doctorId, dto.priority);
    }
...
__decorate([
    (0, common_1.Post)(),
    (0, swagger_1.ApiOperation)({ summary: 'Generate a new token for a patient' }),
    (0, swagger_1.ApiResponse)({ status: 201, description: 'The token has been successfully generated.' }),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Get the waiting queue for a specific doctor' }),
    __param(0, (0, common_1.Param)('doctorId')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], TokensController.prototype, "getDoctorQueue", null);
